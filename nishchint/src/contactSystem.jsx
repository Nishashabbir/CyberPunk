      ...
      {!opened && !loading && (
        <div className="flex justify-center">
          <button
            ...
            className="px-10 py-5 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl hover:scale-105 transition hover:border-[#FF2E88] hover:text-[#7A5CFF] hover:cursor-pointer"
          >
            CONTACT NISHA
          </button>
        </div>
